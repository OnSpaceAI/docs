...
<Update label="07/11/2025">
  - **Agent Workflow Visualization**: Enhanced real-time display of AI agent progress during development. Watch your ideas come to life with crystal-clear insights into every step of the creation process.
  - **Code Editor Unlocked**: Full code editor access for everyone. Free users can now view, explore, and understand the clean code behind their creations. No paywalls between you and your code.
