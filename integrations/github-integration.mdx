...
**Detection**: OnSpace AI checks for conflicts before every push operation **When conflicts arise**:

1. Auto-sync temporarily pauses
2. Conflict markers appear in your GitHub repository
3. Standard Git merge resolution applies
4. OnSpace AI resumes sync after resolution is committed