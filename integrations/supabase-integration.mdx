...
To connect Supabase in OnSpace: Open your project, click "Rephrase Browser" → Supabase icon → select your project from the dropdown. When you see the green "Connect" message, the setup is complete.
