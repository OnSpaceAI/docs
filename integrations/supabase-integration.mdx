...
description: "Supercharge your OnSpace builds with Supabase's all-in-one backend platform, creating dynamic full-stack applications with enterprise-grade capabilities."
icon: "server"
---
...
1. **Create a new organization**
   ...
   <img
     src="/images/supabase-org.jpg"
     alt="supabase-org.jpg"
     title="supabase-org.jpg"
     className="mr-auto"
     style={{ width:"60%" }}
   />
2. **Create a new project**
   ...
   <img
     src="/images/supabase-project.jpg"
     alt="supabase-project.jpg"
     title="supabase-project.jpg"
     className="mr-auto"
     style={{ width:"60%" }}
   />
...
<img
  src="/images/supabase-2.gif"
  alt="supabase-2.gif"
  title="supabase-2.gif"
  className="mr-auto"
  style={{ width:"100%" }}
/>
...
<img
  src="/images/Supabase-acct-auth.gif"
  alt="Supabase-acct-auth.gif"
  title="Supabase-acct-auth.gif"
  className="mr-auto"
  style={{ width:"100%" }}
/>
...
<img
  src="/images/Supabase-Select-Project.gif"
  alt="Supabase-Select-Project.gif"
  title="Supabase-Select-Project.gif"
  className="mr-auto"
  style={{ width:"100%" }}
/>
...
<img
  src="/images/Supabase-completion.gif"
  alt="Supabase-completion.gif"
  title="Supabase-completion.gif"
  className="mr-auto"
  style={{ width:"100%" }}
/>
